...
function toggleUserDropdown(dropdownId) {
  ...
  if (!dropdown) return console.warn("Dropdown not found:", dropdownId);

  dropdown.classList.toggle("show");
  console.log(dropdown.id, dropdown.className);
}

// Close dropdown when clicking outside
document.addEventListener("click", function (event) {
  const dropdowns = document.querySelectorAll(".dropdown-menu-info");

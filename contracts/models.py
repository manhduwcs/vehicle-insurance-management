...
class Contracts(models.Model):
    ...
    vehicle_id = models.ForeignKey(Vehicle, on_delete=models.CASCADE, db_column='VehicleID')
    insurance_category_id = models.ForeignKey(InsuranceCategories, on_delete=models.CASCADE, db_column='InsuranceCategoryID')
    ...
    duration_id = models.ForeignKey(Duration, on_delete=models.CASCADE, db_column='DurationID')

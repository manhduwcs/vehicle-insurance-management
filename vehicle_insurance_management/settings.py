"""
Django settings for vehicle_insurance_management project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cores.context_processors.customer_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'vehicle_insurance_management.wsgi.application'
...
# ✅ where collectstatic will dump all files (leave empty in git)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# ✅ where you keep your own static source files
STATICFILES_DIRS = [
